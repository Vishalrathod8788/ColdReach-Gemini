    ...
    return (
        <>
            <footer className="border-t bg-white w-full mt-auto">
                <div className="mx-auto px-6 sm:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-0" style={{ maxWidth: '1150px' }}>
                    <a
                        href="https://github.com/Vishalrathod8788/ColdReach-Gemini"
                        target="_blank"
